 ...
 *
 * @package WordPress
 * @subpackage bvportfolio
 * @since bvportfolio 2.6.0
 */
...
function bvportfolio_adjust_image_sizes_attr( $sizes, $size ) {
...
add_filter( 'wp_calculate_image_sizes', 'bvportfolio_adjust_image_sizes_attr', 10 , 2 );

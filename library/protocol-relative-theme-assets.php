 ...
 *
 * @package bvportfolio
 * @since bvportfolio 1.1.0
 */

if ( ! class_exists( 'bvportfolio_protocol_relative_theme_assets' ) ) :
	class bvportfolio_protocol_relative_theme_assets {
		/**
	...
	$bvportfolio_protocol_relative_theme_assets = new bvportfolio_protocol_relative_theme_assets;
endif;

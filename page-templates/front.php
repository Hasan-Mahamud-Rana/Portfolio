...
<header id="front-hero" role="banner">
	<div class="marketing">
		<div class="tagline">
			...
			<a role="button" class="download large button sites-button hide-for-small-only" href="https://github.com/olefredrik/bvportfolio">Download bvportfolio</a>
		</div>
		<div id="watch">
			<section id="stargazers">
				<a href="https://github.com/olefredrik/bvportfolio">1.5k stargazers</a>
			</section>
			<section id="twitter">
...
<section class="intro" role="main">
	<div class="fp-intro">
		<div <?php post_class() ?> id="post-<?php the_ID(); ?>">
			<?php do_action( 'bvportfolio_page_before_entry_content' ); ?>
			...
			<?php do_action( 'bvportfolio_page_before_comments' ); ?>
			<?php comments_template(); ?>
			<?php do_action( 'bvportfolio_page_after_comments' ); ?>
		</div>
	</div>
</section>
<?php endwhile;?>
